...
public class Minesweeper extends Application {
	...
	public void start(Stage mainStage) {
		...
		btReset.setStyle(Board.BUTTON_STYLE);
		btReset.setMinSize(Board.squareSize * 2, Board.squareSize);
		btReset.setMaxSize(Board.squareSize * 2, Board.squareSize);
		btReset.setFont(new Font("", Board.squareSize * .45));
		...
		Scene scene = new Scene(vBox, width * Board.squareSize, height * Board.squareSize + Board.squareSize);
...
class Board extends GridPane {
	final static String BUTTON_STYLE = "-fx-border-radius: 0; -fx-border-color: #999999;"
			+ " -fx-background-radius: 0; -fx-background-color: #ffffff;";
	final static String FLAG = "P";
	 ...
	 */
	private void win() {
		Minesweeper.btReset.setText(":)");
		Minesweeper.btReset.setStyle(BUTTON_STYLE + "-fx-background-color: #00ff00");
		for (int c = 0; c < width; c++) {
			for (int r = 0; r < height; r++) {
	...
	private void lose() {
		...
		Minesweeper.btReset.setText(":(");
		Minesweeper.btReset.setStyle(BUTTON_STYLE + "-fx-background-color: #ff0000");
	}
	/**
